...
type ImportDocumentOptions struct {
	...
	FromPrefix string `arangodb:"fromPrefix,omitempty" json:"fromPrefix,omitempty"`
	...
	ToPrefix string `arangodb:"toPrefix,omitempty" json:"toPrefix,omitempty"`
	...
	Overwrite bool `arangodb:"overwrite,omitempty" json:"overwrite,omitempty"`
	...
	OnDuplicate ImportOnDuplicate `arangodb:"onDuplicate,omitempty" json:"onDuplicate,omitempty"`
	...
	Complete bool `arangodb:"complete,omitempty" json:"complete,omitempty"`
}
...
type ImportDocumentStatistics struct {
	...
	Created int64 `arangodb:"created,omitempty" json:"created,omitempty"`
	// Errors holds the number of documents that were not imported due to an error.
	Errors int64 `arangodb:"errors,omitempty" json:"errors,omitempty"`
