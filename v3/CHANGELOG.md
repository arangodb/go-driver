...
- Replication: removed applier API (`GetApplierConfig`, `UpdateApplierConfig`, `ApplierStart`, `ApplierStop`, `GetApplierState`, `MakeFollower`) and related types; not available in ArangoDB 4.0. WAL server identity type renamed to `ReplicationServer`.
