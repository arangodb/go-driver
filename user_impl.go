...
type userData struct {
	Name           string     `arangodb:"user,omitempty"`
	Active         bool       `arangodb:"active,omitempty"`
	Extra          *RawObject `arangodb:"extra,omitempty"`
	ChangePassword bool       `arangodb:"changePassword,omitempty"`
}
...
type userAccessibleDatabasesResponse struct {
	Result map[string]string `arangodb:"result"`
}
