...
Define driver behavior for Toxiproxy latency faults: high latency success, extreme latency timeout, latency removal, client context timeout, and HTTP/1 response-header timeout.
