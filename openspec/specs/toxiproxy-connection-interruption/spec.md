...
Define driver behavior for Toxiproxy connection-interruption faults (abrupt TCP close, proxy disable, downstream reset) including fail-then-recover expectations and the shared proxy harness contract.
