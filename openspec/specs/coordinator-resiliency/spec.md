...
Define driver behavior when ArangoDB coordinators restart or are killed during idle periods, active version probes, cursor reads, inserts, and cursor iteration.
