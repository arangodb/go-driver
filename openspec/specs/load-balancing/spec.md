...
Define observational expectations for how ingress distributes driver traffic across ArangoDB coordinators, with no fault injected, using the shared resiliency harness endpoints.
