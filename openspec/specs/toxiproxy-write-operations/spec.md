...
Define driver behavior when Toxiproxy disconnects during document insert or transaction commit, requiring category A failures and treating write/commit outcomes as unknown.
