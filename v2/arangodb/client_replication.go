...
type ClientReplication interface {
	...
	//
	// Deprecated: Part of the single-single replication API used by leader-follower
	// (deprecated since 3.9) and Active Failover (deprecated in 3.11, removed in 3.12).
	// Removed in ArangoDB 3.12.10 because of a security issue inherent to the applier
	// design (GET /_api/replication/applier-config). On older versions this method still works.
	...
	// (deprecated since 3.9) and Active Failover (deprecated in 3.11, removed in 3.12).
	// Removed in ArangoDB 3.12.10 because of a security issue inherent to the applier
	// design (PUT /_api/replication/applier-config). On older versions this method still works.
	...
	// (deprecated since 3.9) and Active Failover (deprecated in 3.11, removed in 3.12).
	// Removed in ArangoDB 3.12.10 because of a security issue inherent to the applier
	// design (PUT /_api/replication/applier-start). On older versions this method still works.
	...
	// (deprecated since 3.9) and Active Failover (deprecated in 3.11, removed in 3.12).
	// Removed in ArangoDB 3.12.10 because of a security issue inherent to the applier
	// design (PUT /_api/replication/applier-stop). On older versions this method still works.
	...
	// (deprecated since 3.9) and Active Failover (deprecated in 3.11, removed in 3.12).
	// Removed in ArangoDB 3.12.10 because of a security issue inherent to the applier
	// design (PUT /_api/replication/make-follower). On older versions this method still works.
