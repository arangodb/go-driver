...
type ArangoError struct {
	HasError     bool   `arangodb:"error" json:"error"`
	Code         int    `arangodb:"code" json:"code"`
	ErrorNum     int    `arangodb:"errorNum" json:"errorNum"`
	ErrorMessage string `arangodb:"errorMessage" json:"errorMessage"`
}
