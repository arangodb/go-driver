...
type queryRequest struct {
	...
	Count bool `arangodb:"count,omitempty"`
	...
	BatchSize int `arangodb:"batchSize,omitempty"`
	...
	Cache bool `arangodb:"cache,omitempty"`
	...
	MemoryLimit int64 `arangodb:"memoryLimit,omitempty"`
	...
	TTL float64 `arangodb:"ttl,omitempty"`
	// contains the query string to be executed
	Query string `arangodb:"query"`
	// key/value pairs representing the bind parameters.
	BindVars map[string]interface{} `arangodb:"bindVars,omitempty"`
	Options  struct {
		...
		Profile bool `arangodb:"profile,omitempty"`
		...
		OptimizerRules string `arangodb:"optimizer.rules,omitempty"`
		...
		SatelliteSyncWait float64 `arangodb:"satelliteSyncWait,omitempty"`
		...
		FullCount bool `arangodb:"fullCount,omitempty"`
		// Limits the maximum number of plans that are created by the AQL query optimizer.
		MaxPlans int `arangodb:"maxPlans,omitempty"`
	} `arangodb:"options,omitempty"`
}
