...
type CreateCollectionOptions struct {
	...
	JournalSize int `arangodb:"journalSize,omitempty"`
	...
	IsVolatile bool `arangodb:"isVolatile,omitempty"`
	...
	IndexBuckets int `arangodb:"indexBuckets,omitempty"`
	// Specifies how keys in the collection are created.
	KeyOptions *CollectionKeyOptions `arangodb:"keyOptions,omitempty"`
}
