...
type getGraphsResponse struct {
	Graphs []DocumentMeta `arangodb:"graphs,omitempty"`
}
...
type createGraphOptions struct {
	...
	OrphanVertexCollections []string                      `arangodb:"orphanCollections,omitempty"`
	EdgeDefinitions         []EdgeDefinition              `arangodb:"edgeDefinitions,omitempty"`
	IsSmart                 bool                          `arangodb:"isSmart,omitempty"`
	Options                 *createGraphAdditionalOptions `arangodb:"options,omitempty"`
}
...
type createGraphAdditionalOptions struct {
	...
	SmartGraphAttribute string `arangodb:"smartGraphAttribute,omitempty"`
